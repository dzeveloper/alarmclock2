...
const int offset = 1;   // Central European TimeLib
//const int offset = -5;  // Eastern Standard TimeLib (USA)
//const int offset = -4;  // Eastern Daylight TimeLib (USA)
//const int offset = -8;  // Pacific Standard TimeLib (USA)
//const int offset = -7;  // Pacific Daylight TimeLib (USA)
...
void loop()
{
  while (SerialGPS.available()) {
    if (gps.encode(SerialGPS.read())) { // process gps messages
      ...
      if (age < 500) {
        // set the TimeLib to the latest GPS reading
